...
const BlogSection = () => {
    ...
    return (
        <section className='mt-32'>
            ...
            >
                <SwiperSlide>
                    <div className="h-full card-body regular-font">
                        <span className="result"><strong className="gpa">GPA 4.00</strong></span>
